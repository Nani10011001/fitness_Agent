...
toast.error(error.mess)
  ...
  return (
   <div className='bg-primary/80 min-h-screen flex justify-center items-center'>
      ...
      <h3 className='text-center text-emerald-600 text-2xl font-bold my-4 text-primary uppercase '>login</h3>
      ...
      <div className='px-4 mt-5 text-center'>
        <button type='submit'
         className='bg-emerald-500 cursor-pointer w-full py-3 rounded-md text-slate-600 font-semibold'>Login</button>
         </div>
      ...
      <div className='flex justify-center mt-5'>
        <p className='text-gray-300'>if you don't  have account <Link  to="/signup" className=" cursor-pointer  text-emerald-500 underline ml-1 text-primary">signup</Link></p>
      </div>
      </div>
